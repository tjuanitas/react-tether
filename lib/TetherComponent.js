...
var ReactDOMSharedInternals = _reactDom.default.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;

var findDOMNode = function findDOMNode(instance) {
  return _reactDom.default.findDOMNode ? _reactDom.default.findDOMNode(instance) : ReactDOMSharedInternals.findDOMNode(instance);
};

...
var _ReactDOMSharedInternals = _reactDom.default.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;

var _findDOMNode = (instance) => _reactDom.default.findDOMNode ? _reactDom.default.findDOMNode(instance) : _ReactDOMSharedInternals.findDOMNode(instance);
...
function (_Component) {
  ...
  _createClass(TetherComponent, [{
    ...
    value: function _update() {
      ...
      if (!shouldDestroy) {
        this._targetNode = _findDOMNode(this);
